    ...
    <style>
        * {
        ...
        .promo-hero-image {
            ...
            filter: brightness(1.08) contrast(1.2) saturate(1.25) sharpness(0.4);
...
<body>
    ...
    <main class="main-content">
        ...
        <section class="promo-hero">
            ...
            <img src="../pictures/dashboard1.png" alt="Dwellscape South Residences" class="promo-hero-image" id="promoHeroImage">
                ...
                <div class="experience-content">
                    <div class="experience-images">
                        <div class="image-collage">
                            <img src="../pictures/dashboard2.png" alt="Luxury Staycation Experience" class="collage-image" onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1617093727343-374698b1b8dc?q=80&w=1200&auto=format&fit=crop';">
            ...
            <div class="container">
                ...
                <div class="virtual-tour-container" style="background: white; border-radius: 12px; padding: 40px; margin-bottom: 40px;">
                    <div class="embed-16x9">
                        <img src="../pictures/virtual.jpg" alt="Virtual tour preview">
                    </div>
                    ...
                    try {
                        ...
                        if (empty($gallery_images)) {
                            ...
                            foreach ($gallery_images as $image):
                                ...
                                elseif (preg_match('~^\.\./pictures/~i', $raw_url)) {
                                    // Already correct for dashboard.php
                                    $image_url = $raw_url;
                                }
            ...
            <div class="container">
                ...
                <div class="about-content" style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; margin-bottom: 60px; align-items: center;">
                    ...
                    <div class="about-image" style="position: relative; border-radius: 12px; overflow: hidden; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.1);">
                        <img src="../pictures/virtual.jpg" alt="About Dwellscape" style="width: 100%; height: 400px; object-fit: cover;">
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // All of these files live in: C:\xampp\htdocs\pictures
            // Order: 1) Building, 2) Pool, 3) Playground, 4) Billiards room
            const heroSlides = [
                '../pictures/dashboard1.png',      // main building (first slide)
                '../pictures/dashboard2.png',      // pool
                '../pictures/dashboard3.png',      // playground
                '../pictures/dashboard4.png'       // billiards / activity room
            ];
            ...
            function setActiveSlide(index) {
                ...
                // Simple fade effect using opacity transition
