...
<body>
    ...
    <main class="main-content">
        <section class="hero-section">
            <img src="../pictures/dashboard1.png" alt="Dwellscape South Residences" class="hero-background" id="homeHeroImage">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const heroSlides = [
                ...
                '../pictures/dashboard2.png',
                '../pictures/dashboard3.png',
                '../pictures/dashboard4.png'
            ];
