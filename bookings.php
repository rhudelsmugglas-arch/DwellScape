...
<body>
    ...
    <main class="main-content">
        ...
        <section class="booking-hero-section">
            <!-- Background image -->
            <img src="../pictures/bookings.png" alt="Dwellscape Booking" class="booking-hero-image">
    ...
    <script>
        ...
        async function fetchBookedDates() {
            try {
                const response = await fetch('get_booked_dates.php');
                const result = await response.json();
        ...
        function closeTermsModal() {
            ...
            document.getElementById('acceptTermsBtn').textContent = 'Please Accept Terms First';
        }
        ...
        function showDateTimeModal(checkinDate) {
            ...
            checkoutDatePicker.min = minCheckout.toISOString().split('T')[0];
        ...
        async function displayRooms(checkin, checkout, time = null) {
            ...
            try {
                ...
                const response = await fetch('get_available_rooms.php', {
                    method: 'POST',
                    headers: {
        ...
        async function initiatePayment(bookingData) {
            try {
                ...
                const checkPayment = setInterval(async function() {
                    try {
                        const checkResponse = await fetch('check_payment.php?payment_link_id=' + result.payment_link_id);
        ...
        async function bookRoom(roomId, checkin, checkout, nights, totalPrice) {
            ...
            try {
                const availabilityResponse = await fetch('check_room_availability.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
